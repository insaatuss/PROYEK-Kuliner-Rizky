...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/KR.png" rel="icon">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="action_edit.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                  ...
                  <input type="file" name="gambar" class="form-control" id="gambar_produk" value="<?php echo $gambar?>" >
                </div>

                <div class="col-md-12">
                  <label for="nama_produk" class="form-label">Nama Produk</label>
                  <input type="text" class="form-control" id="nama_produk" name="nama" value="<?php echo $nama?>" placeholder="Nama Produk" required>
                </div>

                <div class="col-md-12">
                  <label for="deskripsi_produk" class="form-label">Deskripsi Produk</label>
                  <textarea name="deskripsi" id="deskripsi_produk" class="form-control" placeholder="Deskripsi Produk" required> <?php echo $deskripsi?> </textarea>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="number" class="form-control" id="harga_produk" name="harga" value="<?php echo $harga?>" placeholder="Harga Produk" required >
                </div>
